...
<head>
    ...
    <!-- <link href="/node_modules/foundation-sites/dist/css/foundation.min.css" rel=stylesheet> -->
    <link href="/dist/lib/foundation-6.5.1/css/foundation.min.css" rel=stylesheet>
    <link href="/dist/css/nav.css" rel=stylesheet>
    <link href="/dist/css/fonts.css" rel=stylesheet>
    <link href="/dist/css/home-page.css" rel=stylesheet>
    <link href="/dist/css/spacers.css" rel=stylesheet>
    <link href="/dist/css/footer.css" rel=stylesheet>
    <title>Strategic Operational services</title>
    <base href=/ />
    ...
    <div class="grid-container">
        <div class="grid-x">
            <div class="cell small-12">
                <img src="/dist/images/hp_banner.png" width="100%" />
            </div>
        </div>
        <div class="spacer-inline spacer30"></div>
        <div class="grid-x">
            <div class="cell small-12">
                ...
                <p>
                    Recently expanding into the Westchester Area, Strategic Operational has already modified the growing skyline of White plains and Tarrytown. Our NYC operation has built a healthy clientele in services such as interior re-design and flooring. Currently, we are upgrading our website, but we are open for business and eager to provide new clientele with a variety of products and services that we offer. 
                </p>
            </div>
        </div>
    </div>
